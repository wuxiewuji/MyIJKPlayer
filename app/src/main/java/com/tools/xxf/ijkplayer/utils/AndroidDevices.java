...
import com.tools.xxf.ijkplayer.BaseApplication;
...
public class AndroidDevices {
    ...
    public static boolean isPhone() {
        TelephonyManager manager = (TelephonyManager) BaseApplication.getContext().getSystemService(Context
                .TELEPHONY_SERVICE);
    ...
    public static boolean hasConnection() {
        ...
        ConnectivityManager connectivity = (ConnectivityManager) (BaseApplication.getContext().getSystemService
